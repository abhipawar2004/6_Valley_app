  ...
  if(Firebase.apps.isEmpty) {
    if(Platform.isAndroid) {
      try{
        ...
        /// 2. Replace the values below with your Firebase project values:
        await Firebase.initializeApp(
          name: 'your_project_name',  // Replace with your Firebase project name
          options: const FirebaseOptions(
            apiKey: "YOUR_FIREBASE_API_KEY",  // From google-services.json: current_key
            projectId: "YOUR_PROJECT_ID",  // From Firebase Console
            messagingSenderId: "YOUR_SENDER_ID",  // From google-services.json: project_number
            appId: "YOUR_APP_ID"  // From google-services.json: mobilesdk_app_id
          )
        );
      } catch(e) {
        // If the above fails, try using the google-services.json file directly
        await Firebase.initializeApp();
      }
    }else{
      await Firebase.initializeApp();
